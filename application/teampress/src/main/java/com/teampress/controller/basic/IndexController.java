...
public class IndexController extends BaseController {
    ...
    public ModelAndView showIndex() {
        if(hasPermission(Permissions.LOGGED_IN)) {
            ...
            if(hasPermission(Permissions.HOME_HEADER_BUTTONS)) {
                ...
                view.addObject("nextTraining", trainingPlanService.findNextTrainingPlan(uOrg.getOrganization(), uOrg.getType()));
                view.addObject("nextTrainingDay", getDay(trainingPlanService.findNextTrainingPlan(uOrg.getOrganization(), uOrg.getType())));
            }
    ...
    private String getDay(TrainingPlan trainingPlan) {
        if(Objects.nonNull(trainingPlan)){
            ...
            calendar.setTime(trainingPlan.getTrainingDate());
